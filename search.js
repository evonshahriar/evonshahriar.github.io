...
document.getElementById('search-form').addEventListener('submit', function(event) {
    ...
    const pages = [
        ...
        { title: 'Projects', url: 'projects.html', content: 'Projects AI Research Mentor ARM AI-based Water Quality Monitoring System Optimizing Development Aid Allocation Navigation App for Visually Impaired' },
